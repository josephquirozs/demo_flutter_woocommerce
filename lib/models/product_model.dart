...
class ProductModel {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
        ...
        metaData: List<MetaDatumModel>.from(
            json["meta_data"].map((x) => MetaDatumModel.fromJson(x))),
...
class MetaDatumModel {
  ...
  factory MetaDatumModel.fromJson(Map<String, dynamic> json) => MetaDatumModel(
        id: json["id"],
        key: json["key"],
        value: json["value"],
      );
